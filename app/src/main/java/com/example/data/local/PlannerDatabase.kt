...
@Database(entities = [StudySession::class, PdfAnnotation::class, PdfBookmark::class, OfflineBook::class, NotificationEntity::class, CalculatorHistoryEntity::class], version = 6, exportSchema = false)
